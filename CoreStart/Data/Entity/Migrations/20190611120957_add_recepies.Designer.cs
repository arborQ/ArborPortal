...
namespace CoreStart.Data.Entity
{
    ...
    [Migration("20190611120957_add_recepies")]
    partial class add_recepies
    {
            ...
            modelBuilder.Entity("CoreStart.Data.Entity.Models.Account.User", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2019, 6, 11, 12, 9, 56, 908, DateTimeKind.Utc).AddTicks(8533));
            ...
            modelBuilder.Entity("CoreStart.Data.Entity.Models.Recipes.Recipe", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2019, 6, 11, 12, 9, 56, 915, DateTimeKind.Utc).AddTicks(7393));
